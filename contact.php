                                    ...
                                    <div class="simplebar-content">
                                        <div class="card-body bg-light wow fadeInLeft" data-wow-delay="0.3s">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                No. B102 RAMAT SHOPPING COMPLEX Opposite Leventis Junction, Maiduguri, Borno State.
                                                </span>
                                            </p>
                                            <p class="mb-0">
                                                <strong class="text-black">
                                            ...
                                            <p class="mb-0">
                                                ...
                                                <span class="text-black">
                                                    <!-- support@tyt.us -->
                                                    Media Inquiries: <a href="mailto:media@tyt.us" style="color:blue">help@infiniti24.com</a>
                                                </span> 
                                                <br>
                                                <span class="text-black">
                                                   Partnership Inquiries: <a href="mailto:partner@tyt.us" style="color:blue">help@infiniti24.com</a>
                                                </span>
                                                <br>
                                                <span class="text-black">
                                                   File a complaint: <a href="mailto:compliance@tyt.us" style="color:blue">help@infiniti24.com</a>
                                                </span>
                                                <br>
                                                 <span class="text-black">
                                                    General Inquiries: <a href="mailto:info@tyt.us" style="color:blue">help@infiniti24.com</a>
                                                </span>
